  ...
  return (
    <div id="main" className="w-full h-screen text-center">
      <div className="max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center  ">
        <div>
          <p className="uppercase text-sm tracking-widest text-[#e4e4e7]">
            let's build something togetheir{" "}
          </p>
          <h1 className="py-2 text-[#e4e4e7]">
            Hi, I am <span className="text-[#e4e4e7]">Rahul</span>
          </h1>
          <h1 className="py-4 text-[#e4e4e7] ">
            <span id="typed">A Front-End Developer</span>
          </h1>
          <p className="py-4 text-[#e4e4e7] max-w-[70%] m-auto">
