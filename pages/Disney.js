...
import ConnectImg from "../public/assets/projects/disney.png";
    ...
    <div className="w-full">
      <div className="w-screen h-[50vh] relative">
        ...
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2">
          <h2 className="py-2">Disney plus Clone</h2>
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8">
        <div className="col-span-4">
          ...
          <h2>Overview</h2>
          <p>
            React JS and the Javascript library were used to develop this app,
            which is a replica of Disney Plus hosted on Netlify.
            Styled-Components were then used to style the website, and the data
            was then written in JSON format.
          </p>
          <a
            href="https://github.com/Shady-45/Disney_clone"
            target="_blank"
            rel="noreferrer"
          >
